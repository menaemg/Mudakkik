...
const SectionLabel = ({ title }) => (
    <div className="mb-8 border-b border-gray-200 flex justify-between items-end pb-2">
        <h2 className="bg-black text-white px-6 py-2 font-black text-lg inline-block relative top-[1px] shadow-md">
            {title}
        </h2>
        <a href="#" className="text-xs font-bold text-gray-500 hover:text-[#b20e1e] flex items-center gap-1 transition-colors mb-1 group">
            عرض المزيد <FaArrowLeft className="group-hover:-translate-x-1 transition-transform" />
        </a>
    </div>
);

const MainEntertainCard = () => (
    <div className="relative h-[600px] w-full group cursor-pointer overflow-hidden rounded-xl shadow-2xl" data-aos="zoom-in">
        <img
            src="https://images.unsplash.com/photo-1517999144091-3d9dca6d1e43?w=800&fit=crop"
            alt="Main Entertainment"
        ...
        <div className="absolute bottom-8 right-8 left-8 bg-[#b20e1e]/95 backdrop-blur-sm p-8 text-white shadow-xl border-t-4 border-white/20 rounded-sm">
            ...
            <h2 className="text-3xl md:text-4xl font-black leading-tight mb-4 drop-shadow-md">
                نجوم هوليوود يجتمعون الليلة في العرض الأول لفيلم الموسم المنتظر
            </h2>
            <div className="flex items-center gap-3 text-xs text-white/90 font-medium border-t border-white/20 pt-4">
                <Avatar className="w-8 h-8 border-2 border-white/30 shadow-sm">
                    <AvatarImage src="https://randomuser.me/api/portraits/men/32.jpg" />
                    <AvatarFallback>SM</AvatarFallback>
                </Avatar>
                <div className="flex flex-col">
                    <span className="font-bold text-white">ستيفن ماسر</span>
...
const VerticalCard = ({ title, image, date, delay }) => (
    <div className="flex flex-col mb-8 last:mb-0 group cursor-pointer bg-white p-3 rounded-xl hover:shadow-xl transition-all duration-300 border border-transparent hover:border-gray-100" data-aos="fade-up" data-aos-delay={delay}>
        <div className="h-48 overflow-hidden rounded-lg mb-3 relative shadow-sm">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/50">
        ...
        <div>
            <div className="flex items-center gap-2 text-[10px] text-[#b20e1e] mb-2 font-black uppercase tracking-wide">
                <span>سينما وتلفزيون</span>
                <span className="text-gray-300 font-normal">|</span>
                <span className="text-gray-400 font-bold">{date}</span>
            </div>
            <h3 className="font-bold text-lg leading-snug text-gray-900 group-hover:text-[#b20e1e] transition-colors line-clamp-2">
                {title}
            </h3>
        </div>
    </div>
...
const SideListItem = ({ title, author, delay }) => (
    <div className="mb-6 border-b border-gray-100 pb-4 last:border-0 group hover:translate-x-[-5px] transition-transform duration-300" data-aos="fade-left" data-aos-delay={delay}>
        <span className="text-[10px] text-[#b20e1e] font-bold block mb-1 uppercase">مقال رأي</span>
        <h4 className="font-bold text-[15px] leading-snug text-gray-900 mb-2 group-hover:text-brand-blue cursor-pointer transition-colors">
            {title}
        </h4>
...
export default function EntertainmentSection() {
    return (
        <section className="container mx-auto px-4 py-16 bg-gray-50/30">
            <SectionLabel title="ترفيه وفنون" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-3 flex flex-col h-full justify-between">
                    <VerticalCard
                        delay="100"
                        title="أسطورة الكوميديا يعلن اعتزاله بعد جولته الأخيرة وسط دموع الجمهور"
                        date="25 يوليو"
                        image="https://images.unsplash.com/photo-1543584756-8f40a802e14f?w=500&fit=crop"
                    />
                    <VerticalCard
                        delay="200"
                        title="المهرجان الموسيقي يجذب حشوداً هائلة رغم تحذيرات الطقس"
                        date="25 يوليو"
                        image="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&fit=crop"
                    />
                </div>

                <div className="lg:col-span-3">
                    <div className="h-[250px] bg-gradient-to-br from-pink-600 to-rose-700 mb-8 flex flex-col items-center justify-center text-white text-center p-6 rounded-xl shadow-xl relative overflow-hidden group" data-aos="fade-left">
                        ...
                        <div className="relative z-10">
                            <h4 className="text-2xl font-black mb-3 drop-shadow-md">أفكار تشكل<br/>المستقبل</h4>
                            <p className="text-xs text-white/80 mb-5">اكتشف أحدث صيحات الفن</p>
                            <button className="bg-white text-rose-600 border border-white px-6 py-2 text-xs font-bold rounded-full hover:bg-transparent hover:text-white transition-all shadow-lg">
                                اعرف المزيد
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        <SideListItem
                            delay="300"
                            title="تأجيل المهرجان الموسيقي بسبب الطقس غير المتوقع"
                            author={{name: "دانيال براون", img: "https://randomuser.me/api/portraits/men/85.jpg"}}
                        />
                        <SideListItem
                            delay="400"
                            title="نجم البوب يطلق ألبوماً جديداً يتصدر القوائم العالمية"
                            author={{name: "جويل ميسنر", img: "https://randomuser.me/api/portraits/men/52.jpg"}}
                        />
                        <SideListItem
                            delay="500"
                            title="شباك التذاكر يحقق أرقاماً قياسية بعد إصدارات الصيف"
                            author={{name: "توماس لوسون", img: "https://randomuser.me/api/portraits/men/45.jpg"}}
                        />
                    </div>
                </div>
...
// export default function EntertainmentSection({ posts = [] }) {
...
//             <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
//                 <div className="lg:col-span-6">
//                     {isLoading ? <MainCardSkeleton /> : <MainEntertainCard post={posts[0]} />}
//                 </div>
...
//                     ) : (
//                         <>
//                             {posts[1] && <VerticalCard post={posts[1]} delay="100" />}
//                             {posts[2] && <VerticalCard post={posts[2]} delay="200" />}
//                         </>
//                     )}
//                 </div>
