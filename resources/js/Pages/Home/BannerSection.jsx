...
const BannerSkeleton = () => (
    <section className="container mx-auto px-4 py-8 md:py-12 mb-8">
        <div className="relative w-full h-[400px] sm:h-[450px] rounded-2xl bg-gray-200 animate-pulse overflow-hidden border border-gray-100">
...
useEffect(() => {
    ...
    return (
        <section className="container mx-auto px-4 py-8 md:py-12 mb-8" data-aos="fade-up">
            <div className="relative w-full h-[400px] sm:h-[450px] rounded-2xl overflow-hidden group cursor-pointer shadow-2xl border border-gray-100">
                <img
                    src={content.image}
                    alt={content.title}
                ...
                <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-8 md:px-16 w-full md:w-2/3 lg:w-1/2 z-10">
                    <div className="flex items-center gap-2 mb-4">
                        <span className="text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider flex items-center gap-1 bg-brand-red animate-pulse">
                            <FaBolt />
                            {content.category}
                        </span>
                    </div>

                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-6 drop-shadow-xl group-hover:text-gray-100 transition-colors">
                        {content.title}
                    </h2>
                    ...
                    <div className="flex gap-4">
                        <a href={content.link}>
                            <Button className="rounded-full px-6 py-5 sm:px-8 sm:py-6 text-sm sm:text-base font-bold shadow-lg hover:-translate-y-1 transition-all bg-brand-red hover:bg-red-700 text-white shadow-red-900/50">
