...
import { X, Layers, Hash, AlignRight, FileText, Calendar, Info } from "lucide-react";
                        ...
                        <div className="p-10 space-y-8 text-right" dir="rtl">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <StatCard 
                                    ...
                                    label="تاريخ الإنشاء" 
                                    value={new Date(category.created_at).toLocaleDateString('ar-EG')} 
                            ...
                            <div className="bg-slate-50 p-6 rounded-[1.5rem] border border-slate-100">
                                ...
                                <p className="text-[#001246] font-bold leading-relaxed">
                                    {category.description || "لا يوجد وصف مضاف لهذه الفئة حالياً."}
                                </p>
                            </div>

                        
                            <div className="space-y-4 px-2">
                                <DetailRow label="المعرف الرقمي" value={`#${category.id}`} />
                                <DetailRow label="آخر تحديث" value={new Date(category.updated_at).toLocaleDateString('ar-EG')} />
                            </div>
