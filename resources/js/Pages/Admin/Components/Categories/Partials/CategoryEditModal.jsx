                    ...
                    >
                        ...
                        <div className="bg-[#001246] p-8 text-white flex justify-between items-center" dir="rtl">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-black">تعديل بيانات الفئة</h3>
                                    <p className="text-xs text-white/60 font-bold">تحديث: {category?.name}</p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-6" dir="rtl">
                            ...
                            <div className="space-y-6 text-right">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-[#001246] flex items-center gap-2">
                                        <Link2 size={16} className="text-[#D00000]" /> الرابط المختصر (Slug)
                                    </label>
                                    <input 
                                        type="text" 
                                        value={data.slug} 
                                    ...
                                    />
                                    <p className="text-[10px] text-slate-400 font-bold pr-2">نصيحة: استخدم الشرطة (-) بدلاً من المسافة.</p>
