                        ...
                        >
                            ...
                            <div className="flex items-center gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-blue-300 text-[15px] font-bold mt-1 opacity-80">
                                        @{user.username}
                                    </p>

                                    <span
                                        className={`inline-block mt-3 px-4 py-1 rounded-xl text-[11px] font-black border ${getRoleBadge(
                                            user.role
                                        )}`}
                                    >
...
const StatCard = ({ icon, label, value, color }) => (
    <div className="bg-slate-50 p-5 rounded-[1.8rem] border border-slate-100 text-center hover:bg-white hover:shadow-md transition-all">
        <p
            className={`text-[10px] font-black uppercase mb-1 flex items-center justify-center gap-1 opacity-60`}
        >
            {icon} {label}
        </p>
