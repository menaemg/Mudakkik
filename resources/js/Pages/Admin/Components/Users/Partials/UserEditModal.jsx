...
import { X, Save, Edit3, User, Mail, Shield, Star, FileText } from "lucide-react";
                    ...
                    >
                        <div className="bg-[#001246] p-8 text-white flex justify-between items-center" dir="rtl">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-black">تعديل بيانات الحساب</h3>
                                    <p className="text-xs text-white/60 font-bold">تحديث معلومات: {user?.name}</p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[75vh] overflow-y-auto custom-scrollbar" dir="rtl">
                            
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-right">
                           
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-[#001246] flex items-center gap-2">
                                        <User size={16} className="text-[#D00000]" /> الاسم الكامل
                                    </label>
                                    <input 
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-[#001246] flex items-center gap-2">
                                        <Shield size={16} className="text-[#D00000]" /> اسم المستخدم (@)
                                    </label>
                                    <input 
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-[#001246] flex items-center gap-2">
                                        <Mail size={16} className="text-[#D00000]" /> البريد الإلكتروني
                                    </label>
                                    <input 
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-black text-[#001246]">نوع الحساب (الصلاحية)</label>
                                    <select 
                                ...
                                >
                                    <div className="space-y-2 text-right">
                                        <label className="text-sm font-black text-amber-900 flex items-center gap-2">
                                            <Star size={16} className="text-amber-600" /> نقاط المصداقية الحالية
                                        </label>
                                        <input 
                                    ...
                                    <div className="flex items-center gap-4 pt-8 justify-end">
                                        <span className="text-sm text-amber-900 font-bold">توثيق الحساب كصحفي</span>
                                        <input 
                            ...
                            <div className="space-y-2 text-right">
                                <label className="text-sm font-black text-[#001246] flex items-center gap-2">
                                    <FileText size={16} className="text-[#D00000]" /> النبذة التعريفية
                                </label>
                                <textarea 
                            ...
                            >
                                {processing ? "جاري التحديث..." : "حفظ التغييرات الجديدة"}
                            </button>
                        </form>
                    </motion.div>
                </div>
